...
var todosResource = schema.GroupVersionResource{Group: "todoexample.com", Version: "v1", Resource: "todos"}

var todosKind = schema.GroupVersionKind{Group: "todoexample.com", Version: "v1", Kind: "Todo"}
...
func (c *FakeTodos) Get(name string, options v1.GetOptions) (result *todoexamplev1.Todo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(todosResource, c.ns, name), &todoexamplev1.Todo{})

	if obj == nil {
		return nil, err
	}
	return obj.(*todoexamplev1.Todo), err
}
...
func (c *FakeTodos) List(opts v1.ListOptions) (result *todoexamplev1.TodoList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(todosResource, todosKind, c.ns, opts), &todoexamplev1.TodoList{})
	...
	list := &todoexamplev1.TodoList{ListMeta: obj.(*todoexamplev1.TodoList).ListMeta}
	for _, item := range obj.(*todoexamplev1.TodoList).Items {
...
func (c *FakeTodos) Create(todo *todoexamplev1.Todo) (result *todoexamplev1.Todo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(todosResource, c.ns, todo), &todoexamplev1.Todo{})
...
func (c *FakeTodos) Update(todo *todoexamplev1.Todo) (result *todoexamplev1.Todo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(todosResource, c.ns, todo), &todoexamplev1.Todo{})
...
func (c *FakeTodos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(todosResource, c.ns, name), &todoexamplev1.Todo{})
...
func (c *FakeTodos) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &todoexamplev1.TodoList{})
	return err
}
...
func (c *FakeTodos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *todoexamplev1.Todo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(todosResource, c.ns, name, pt, data, subresources...), &todoexamplev1.Todo{})

...
import (
	v1 "github.com/gianarb/todo-crd/pkg/apis/todoexample/v1"
	"github.com/gianarb/todo-crd/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*TodoexampleV1Client, error) {
	...
	return &TodoexampleV1Client{client}, nil
}

// NewForConfigOrDie creates a new TodoexampleV1Client for the given config and
...
func New(c rest.Interface) *TodoexampleV1Client {
	return &TodoexampleV1Client{c}
}
